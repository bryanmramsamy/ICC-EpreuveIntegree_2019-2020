# Generated by Django 3.0.8 on 2020-07-30 17:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('management', '0010_auto_20200726_2228'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_address', models.CharField(max_length=255, verbose_name='Additional address')),
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='student_registration_report', to=settings.AUTH_USER_MODEL, verbose_name='Student')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_final_score', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Final score')),
                ...
                ('degree_registration_report', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='modules_registration_reports', to='inscription.DegreeRegistrationReport', verbose_name='Degree Registration Report')),
                ...
                ('student_registration_report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='modules_registration_reports', to='inscription.StudentRegistrationReport', verbose_name='Student')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='student_registration_report',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='degrees_registration_reports', to='inscription.StudentRegistrationReport', verbose_name='Student'),
        ),
    ]
