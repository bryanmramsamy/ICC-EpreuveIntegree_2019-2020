    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree_registration_report', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='modules_registration_reports', to='registration.DegreeRegistrationReport', verbose_name='Degree Registration Report')),
                ...
                ('student_registration_report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='modules_registration_reports', to='registration.StudentRegistrationReport', verbose_name='Student')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='degrees_registration_reports', to='registration.StudentRegistrationReport', verbose_name='Student'),
        ),
    ]
