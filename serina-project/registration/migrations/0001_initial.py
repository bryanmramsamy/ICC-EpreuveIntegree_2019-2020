    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='student_rr', to=settings.AUTH_USER_MODEL, verbose_name='Student')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_start', models.DateField(blank=True, null=True, verbose_name='Start date')),
                ('date_end', models.DateField(blank=True, null=True, verbose_name='End date')),
                ('nb_attempt', models.PositiveIntegerField(default=0, verbose_name="Student's attempt number")),
                ('final_score', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Final score')),
                ('approved', models.BooleanField(default=False, verbose_name='Approved')),
                ('payed', models.BooleanField(default=False, verbose_name='Payed')),
                ('course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='modules_rrs', to='management.Course', verbose_name='Course')),
                ...
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='modules_rrs', to='management.Module', verbose_name='Registration module')),
                ('student_rr', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='modules_rrs', to='registration.StudentRegistrationReport', verbose_name='Student Registration Report')),
            ],
            options={
